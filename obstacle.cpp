...
Obstacle::Obstacle()
{
    if (!isTexturesInitialized)
    {
        ...
        if (!texturesObstacles[0].loadFromFile("assets/tree.png", sf::IntRect(0, 0, 64, 64)) ||
            ...
            !texturesObstacles[3].loadFromFile("assets/pompe2.png", sf::IntRect(0, 0, 64, 64)) ||
            !texturesObstacles[4].loadFromFile("assets/pompe3.png", sf::IntRect(0, 0, 64, 64)) ||
            !texturesObstacles[5].loadFromFile("assets/pompe4.png", sf::IntRect(0, 0, 64, 64)))
            printf("Erreur chargement des textures d'obstacles");
        isTexturesInitialized = true;
    }
    setTexture(texturesObstacles[rand() % 6]);
