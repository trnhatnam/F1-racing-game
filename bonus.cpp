...
Bonus::Bonus(){
    ...
    switch (rand() % 3){
        case 0: 
            _typeBonus = 0; _valeur = 1; ; setTextureRect(sf::IntRect(0, 0, 64, 64)); break;
        case 1:
            _typeBonus = 1; _valeur = 10; setTextureRect(sf::IntRect(64, 0, 64, 64)); break;
        case 2:
            _typeBonus = 2; _valeur = 10; setTextureRect(sf::IntRect(128, 0, 64, 64));
    }
}
